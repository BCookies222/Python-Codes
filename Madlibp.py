...
class Application(Frame):
	...
	def create_widgets(self):
		...
		Radiobutton(self, text="Belly Button", variable=self.bp, value="bellybutton").grid(row=5, column=1,sticky=W)
		Radiobutton(self, text="Big Toe", variable=self.bp, value="bigtoe").grid(row=5, column=2,sticky=W)
		Radiobutton(self, text="Medula Oblongata", variable=self.bp,value="medulaoblong").grid(row=5, column=3,sticky=W)
