# Write your own version of Madlib program using a different arrangement of widgets
...
class Application(Frame):
	...
	def create_widgets(self):
		...
		Label(self,text="Body Part").grid(row=4,column=1,sticky=W)  # Belly Button, Big Toe, Medulla Oblongata
		...
		Checkbutton(self,text="Itchy",variable=self.itchy).grid(row=5, column=0, sticky=W)
		self.joyous=BooleanVar()
		Checkbutton(self,text="Joyous",variable=self.joyous).grid(row=6, column=0, sticky=W)
		self.electric=BooleanVar()
		Checkbutton(self,text="Electric",variable=self.electric).grid(row=7, column=0, sticky=W)
		...
		Radiobutton(self, text="Big Toe", variable=self.bp, value="big toe").grid(row=6, column=1,sticky=W)
		Radiobutton(self, text="Medula Oblongata", variable=self.bp,value="medula oblongata").grid(row=7, column=1,sticky=W)
		...
		self.t.grid(row=9,column=0, columnspan=4, sticky=W)
